'#Region "Form"
	...
	Constructor Form1Type
		...
		With Grid1
			...
			For i As Integer = 0 To 3  ' Returned code 3221225477 = stack overflow when not enough rows
				.Rows.Add
				.Rows.Item(i)->State = 1
			Next
		...
		ElseIf Not .OwnerData Then
			For iRow As Long = 0 To MAX_ROW
				...
				For iCol As Integer = 1 To .Columns.Count - .FixCols - 1
					...
					' .Rows[iRow][iCol].Text = "" + Str(iRow + 1) + "" + Str(iCol) ' Slowly in this ways
				Next
				' Add the Data ; Gradient Color
				If iRow Mod 2 = 0 Then
					.Rows.Add RowStr, , , , , True, 8421504, clWhiteSmoke  ' Quickly add data to a row
