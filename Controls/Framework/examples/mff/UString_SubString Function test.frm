...
Sub Form1Type.TestGlobalSubString()
	Dim As WString * 512  MsgWstr = "===Test Global SubString Test global SubString function ===" 
	...
	Debug.Print MsgWstr : txtResult.Text = txtResult.Text + Chr(13, 10) + MsgWstr
	' Test 6: Start beyond length
	Dim As WString * 200 result6 = SubString(mainStr, 20, 3, "Append" )
	MsgWstr = "Test 6 - Start beyond length: '" & result6 & "' (Expected: 'Hello WorldAppend')" & IIf(result6 = "Hello WorldAppend", "    OK", "    NOT OK") + Chr(13, 10)
	Debug.Print MsgWstr : txtResult.Text = txtResult.Text + Chr(13, 10) + MsgWstr
	
' Test 7: Replacement longer than replaced
	Dim As WString * 200 result7 = SubString(mainStr, 7, 1, "Good" )
	MsgWstr = "Test 7 - Replacement longer than replaced: '" & result7 & "' (Expected: 'Hello Goodorld')"  & IIf(result7 = "Hello Goodorld", "    OK", "    NOT OK") + Chr(13, 10)
	Debug.Print MsgWstr : txtResult.Text = txtResult.Text + Chr(13, 10) + MsgWstr
	
End Sub

Sub Form1Type.TestUStringSubString()
	Dim As WString * 512 MsgWstr =  "=== Test UString.SubString method ===" 
	Debug.Print MsgWstr : txtResult.Text = txtResult.Text + Chr(13, 10) + MsgWstr
	...
	MsgWstr = "Test 6 - Start beyond length: '" & result6 & "' (Expected: 'Hello WorldAppend')" & IIf(result6 = "Hello WorldAppend", "    OK", "    NOT OK")
	Debug.Print MsgWstr : txtResult.Text = txtResult.Text + Chr(13, 10) + MsgWstr
	
	testStr = "Hello World"
	' Test 7: Replacement longer than replaced
	Dim As UString result7 = testStr.SubString(7, 1, "Good" )
	MsgWstr = "Test 7 - Replacement longer than replaced: '" & result7 & "' (Expected: 'Hello Goodorld')" & IIf(result7 = "Hello Goodorld", "    OK", "    NOT OK")
	Debug.Print MsgWstr : txtResult.Text = txtResult.Text + Chr(13, 10) + MsgWstr
