...
Type IWICImagingFactoryVtbl
	...
	' IWICImagingFactory methods (core)
...
Enum
    DXGI_MODE_ROTATION_UNSPECIFIED = 0   ' Unspecified (default)
    DXGI_MODE_ROTATION_IDENTITY    = 1   ' 0 degrees - normal orientation
    DXGI_MODE_ROTATION_ROTATE90    = 2   ' 90 degrees clockwise
    DXGI_MODE_ROTATION_ROTATE180   = 3   ' 180 degrees (upside down)
    DXGI_MODE_ROTATION_ROTATE270   = 4   ' 270 degrees (90 degrees counter-clockwise)
End Enum
...
Type DXGI_GAMMA_CONTROL
    Scale   As DXGI_RGB                  ' Per-channel scale (multiplication)
    Offset  As DXGI_RGB                  ' Per-channel offset (addition)
    GammaCurve(0 To 1024) As DXGI_RGB   ' Gamma curve control points (usually 1025 points)
End Type
...
Function UnloadD2D1 As Long
		...
		' Verify that pD3D11Device exists
		...
		If pDebug <> 0 Then
			' 0 = D3D11_RLO_SUMMARY (brief report)
	        ' 1 = D3D11_RLO_DETAIL  (detailed report with names)
