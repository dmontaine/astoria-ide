...
Namespace ClassContainer
	Private Property ClassType.ClassName ByRef As WString
		If FClassName > 0 Then Return *FClassName Else Return WStr("")
	End Property
	...
	Private Property ClassType.ClassAncestor ByRef As WString
		If FClassAncestor > 0 Then Return *FClassAncestor Else Return WStr("")
	End Property
...
Private Function ErrDescription(Code As Integer) ByRef As WString
	Select Case Code
	Case 0: Return WStr("No error")
	Case 1: Return WStr("Illegal function call")
	Case 2: Return WStr("File not found signal")
	Case 3: Return WStr("File I/O error")
	Case 4: Return WStr("Out of memory")
	Case 5: Return WStr("Illegal resume")
	Case 6: Return WStr("Out of bounds array access")
	Case 7: Return WStr("Null Pointer Access")
	Case 8: Return WStr("No privileges")
	Case 9: Return WStr("Interrupted signal")
	Case 10: Return WStr("Illegal instruction signal")
	Case 11: Return WStr("Floating point error signal")
	Case 12: Return WStr("Segmentation violation signal")
	Case 13: Return WStr("Termination request signal")
	Case 14: Return WStr("Abnormal termination signal")
	Case 15: Return WStr("Quit request signal")
	Case 16: Return WStr("Return without gosub")
	Case 17: Return WStr("End of file")
