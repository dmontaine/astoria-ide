...
| A5 | **WebBrowser navigation** — follow a link, go back, read the resulting URL/title. | Navigation and history, not just first paint. | 🤖 | - | Unblocked by the A4 fix but not yet run. `a4_page2.html` and the link on page one are in place. |
