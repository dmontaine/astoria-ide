...
**Also active:** the **Fable review remediation queue (T1–T16, 2026-07-11)** — see "⭐ ACTIVE SUB-PROJECT — Fable review remediation" below for the execution order and per-model instructions. **Wave 1 (hygiene: T8, T9, T10, T11, T12, T13) is DONE** — compile-clean and launch-check verified. Next up: **T1 decision gate** (Fable — settings-location memo: APPDATA migration vs. portable-install model), which owner sign-off gates before T2 (implementation) and §13.5 (installer) can proceed. Wave 3 (T3/T4/T7/T2, robustness) and Wave 4 (T5/T6, fragile-core debugger work) remain queued behind that gate.
