...
- [ ] **T-SON-3 — unchecked-`Open` sweep in MFF (F-R-mff).** Same class as the main review's F-R2: apply check-result-and-bail to `CheckedListBox.bas:272,289`, `ComboBoxEdit.bas:569,586`, `ListControl.bas:448,465`, `Bitmap.bas:154`. *(The `Animate.bas:335` site from the review is gone — Animate was dropped.)* **(Sonnet)**
