...
**Also active:** the **Fable review remediation queue (T1–T16, 2026-07-11)** — see "⭐ ACTIVE SUB-PROJECT — Fable review remediation" below for the execution order and per-model instructions. Wave 1 (hygiene) can run immediately and doesn't conflict with the View-menu checkpoint; **§13.5 (installer) is blocked on T1/T2** (settings out of `ExePath`).
