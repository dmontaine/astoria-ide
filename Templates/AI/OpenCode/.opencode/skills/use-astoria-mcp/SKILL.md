...
OpenCode auto-discovers a project-scoped **`.mcp.json`** at the repo root. This template
...
Then restart OpenCode so it picks up the server. See `AGENT_MCP_SETUP.md` in the Astoria
