...
Namespace My.Sys.Forms
	...
	Private:
		...
		Dim nCaretPosX As Integer = 0 ' horizontal caret coordinate
		Dim nCaretPosY As Integer = 0 ' vertical caret coordinate
		Dim WithOldI As Integer = -1
		Dim WithOldTypeName As String
		Dim WithTeEnumOld As TypeElement Ptr
		...
		'Dim FSelEnd As Integer = 0   ' index of current character
		Dim FCurLineCharIdx As Integer = 0   ' index of current character
	...
	Public:
		...
		Declare Sub RefreshRenderTarget()
