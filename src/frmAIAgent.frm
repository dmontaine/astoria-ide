'#Region "Form"
	...
	Type frmAIAgentType Extends Form
		...
		Declare Sub txtAIAgentAPIKey_LostFocus(ByRef Sender As Control)
		Declare Constructor
	...
	Constructor frmAIAgentType
		...
		With txtAIAgentAPIKey
			...
			.Designer = @This
			.OnLostFocus = Cast(Sub(ByRef Designer As My.Sys.Object, ByRef Sender As Control), @txtAIAgentAPIKey_LostFocus)
			.Parent = @HorizontalBox6
		End With
		' cboAIAgentPort
		With cboAIAgentPort
...
Private Sub frmAIAgentType.cmdOK_Click(ByRef Sender As Control)
	...
	ElseIf Trim(cboAIAgentContentSize.Text) = "" Then
		...
		Exit Sub
	End If
	txtAIAgentAPIKey.Text = NormalizeAIAgentAPIKey(txtAIAgentAPIKey.Text)
