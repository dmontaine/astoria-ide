		...
		If tb AndAlso st AndAlso st->ReadPropertyFunc Then
			...
			If st AndAlso st->ImageListClearSub AndAlso st->ImageListAddFromFileSub Then
				...
				For i As Integer = 0 To lvImages.ListItems.Count - 1
					tb->txtCode.InsertLine PosForAdd + i, sLeft & IIf(bInWith, WStr(""), ImageListName) & ".Add" & IIf(lvImages.ListItems.Item(i)->Text(1) = "File", WStr("FromFile"), WStr("")) & " """ & lvImages.ListItems.Item(i)->Text(2) & """, """ & lvImages.ListItems.Item(i)->Text(0) & """"
